      ...
      <div className="bg-white rounded-lg shadow-md overflow-hidden">
        ...
        <div className="p-6 grid grid-cols-2 gap-6">
          ...
          <div>
            ...
            <div className="text-xl font-semibold">${(product.price * product.quantity).toFixed(2)}</div>
          </div>
        </div>

        <div className="bg-gray-50 p-6 border-t flex gap-4">
          <Link to={`/products/${product.id}/edit`} className="flex-1 bg-blue-500 text-white py-2 rounded text-center hover:bg-blue-600">
            Edit
          </Link>
